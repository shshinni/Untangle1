...
procedure TForm5.Action10Execute(Sender: TObject);
begin

end;

procedure TForm5.Action11Execute(Sender: TObject);
begin

end;

procedure TForm5.Action12Execute(Sender: TObject);
begin

end;

procedure TForm5.Action13Execute(Sender: TObject);
begin
...
procedure TForm5.Action9Execute(Sender: TObject);
begin
